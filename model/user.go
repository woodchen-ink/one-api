...
type User struct {
	Id               int            `json:"id"`
	Username         string         `json:"username" gorm:"uniqueIndex:uni_users_username" validate:"max=12"`
...
type WebAuthnCredential struct {
	...
	CredentialId    []byte `json:"credential_id" gorm:"uniqueIndex:uni_webauthn_credentials_credential_id;size:255"`
