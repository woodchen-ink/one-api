...
func setOpenAIRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.RelayPanicRecover(), middleware.OpenaiAuth(), middleware.Distribute(), middleware.DynamicRedisRateLimiter())
	{
		...
		relayV1Router.POST("/responses/input_tokens", relay.ResponsesInputTokensCount)
		relayV1Router.POST("/responses/input_tokens/count", relay.ResponsesInputTokensCount)
		relayV1Router.GET("/responses/:response_id", relay.ResponsesResource)
		relayV1Router.DELETE("/responses/:response_id", relay.ResponsesResource)
		relayV1Router.POST("/responses/:response_id/cancel", relay.ResponsesResource)
		relayV1Router.GET("/responses/:response_id/input_items", relay.ResponsesResource)
		relayV1Router.POST("/conversations", relay.ConversationsCreate)
		relayV1Router.GET("/conversations/:conversation_id", relay.ConversationsResource)
		relayV1Router.POST("/conversations/:conversation_id", relay.ConversationsResource)
		relayV1Router.DELETE("/conversations/:conversation_id", relay.ConversationsResource)
		relayV1Router.POST("/conversations/:conversation_id/items", relay.ConversationItemsResource)
		relayV1Router.GET("/conversations/:conversation_id/items", relay.ConversationItemsResource)
		relayV1Router.GET("/conversations/:conversation_id/items/:item_id", relay.ConversationItemsResource)
		relayV1Router.DELETE("/conversations/:conversation_id/items/:item_id", relay.ConversationItemsResource)
